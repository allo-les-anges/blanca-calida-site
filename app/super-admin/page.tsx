      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 md:p-12">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <Link 
              href="/"
              className="flex-1 md:flex-none group flex items-center justify-center gap-3 bg-[#0f0f0f] hover:bg-slate-900 border border-slate-800 hover:border-slate-700 px-8 py-4 rounded-2xl transition-all duration-300"
            >
            ...
            <button 
              ...
              className="flex-1 md:flex-none group flex items-center justify-center gap-3 bg-[#0f0f0f] hover:bg-red-950/30 border border-slate-800 hover:border-red-800/50 px-8 py-4 rounded-2xl transition-all duration-300"
            >
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-red-400">Déconnexion</span>
          ...
          <section className="lg:col-span-4 space-y-6">
            <div className="bg-[#0a0a0a] border border-slate-800/60 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden group">
              ...
              <form onSubmit={createAdminAccount} className="space-y-4 text-left">
                ...
                <button type="submit" disabled={isGlobalLoading} className="w-full bg-red-700 hover:bg-red-600 py-5 mt-4 rounded-2xl font-black uppercase text-[10px] tracking-[0.2em] transition-all transform active:scale-95 shadow-[0_10px_20px_rgba(185,28,28,0.2)] disabled:opacity-50">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between p-6 gap-6">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button 
                          ...
                          className="h-10 w-10 rounded-xl border border-slate-800 flex items-center justify-center text-slate-600 hover:text-red-500 hover:border-red-500 cursor-pointer transition-all disabled:opacity-30"
