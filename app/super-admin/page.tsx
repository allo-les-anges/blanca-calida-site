...
export default function SuperAdminDashboard() {
  ...
  // FONCTION : SUPPRIMER UN COMPTE (Celle qui manquait au build)
  ...
  if (authStatus === 'denied') return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 text-center">
       <div className="bg-[#0a0a0a] border border-red-900/30 p-12 rounded-[3rem]">
          <XCircle size={64} className="text-red-600 mx-auto mb-6" />
          <h2 className="text-3xl font-serif text-white mb-6">Accès Refusé</h2>
          <button onClick={() => window.location.assign('/login')} className="bg-white text-black px-8 py-3 rounded-xl font-bold uppercase text-[10px]">Retour</button>
       </div>
    </div>
  );
          ...
          <section className="lg:col-span-5 space-y-6">
            <div className="bg-[#0a0a0a] border border-slate-800/60 rounded-[2.5rem] p-8 shadow-2xl text-left">
              ...
              <form onSubmit={createAdminAccount} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[9px] uppercase tracking-widest font-black text-slate-500 ml-2">Password</label>
          ...
          <section className="lg:col-span-7 space-y-6 text-left">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-4">
              <h2 className="text-xl font-serif italic text-white flex items-center gap-3">
                <Users size={20} className="text-red-500" /> Contrats Actifs
              </h2>
            ...
            <div className="space-y-4">
              {filteredAdmins.map((admin) => (
                <div key={admin.id} className="bg-[#0a0a0a] border border-slate-800/60 p-6 rounded-[2rem]">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <button 
                        ...
                        className="h-10 w-10 rounded-xl border border-slate-800 flex items-center justify-center text-slate-700 hover:text-red-500 transition-all"
                      >
