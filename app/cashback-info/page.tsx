  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] pt-32 pb-20 px-6 transition-colors duration-500">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative overflow-hidden bg-[#0F172A] dark:bg-[#111] rounded-[3rem] p-8 md:p-16 mb-20 shadow-2xl border border-transparent dark:border-white/5">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[9px] text-slate-500 dark:text-slate-400 mt-10 italic uppercase tracking-widest text-center">
        ...
        <div className="grid md:grid-cols-3 gap-16 mb-24">
          <div className="group space-y-6">
            ...
            <h3 className="font-bold uppercase text-[11px] tracking-[0.2em] text-slate-900 dark:text-white">Versement Direct</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Un virement bancaire pour couvrir vos frais de notaire ou optimiser votre trésorerie personnelle.</p>
          </div>
          ...
          <div className="group space-y-6">
            ...
            <h3 className="font-bold uppercase text-[11px] tracking-[0.2em] text-slate-900 dark:text-white">Art de Vivre</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Financez l'aménagement de votre nouvelle demeure : mobilier de designer, décoration ou paysagisme.</p>
          </div>
          ...
          <div className="group space-y-6">
            ...
            <h3 className="font-bold uppercase text-[11px] tracking-[0.2em] text-slate-900 dark:text-white">Sérénité Juridique</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Un processus rigoureusement encadré, transparent et validé par nos experts conseils.</p>
          </div>
        </div>
        ...
        <div className="border-t border-slate-100 dark:border-white/10 pt-20">
            <div className="max-w-2xl">
              <h2 className="text-4xl font-serif italic mb-10 text-slate-900 dark:text-white text-left">L'exclusivité Amaru</h2>
              <div className="space-y-8 text-slate-500 dark:text-slate-400 text-lg leading-relaxed">
                <p>
                  Le programme <span className="text-slate-900 dark:text-[#D4AF37] font-medium">Cashback</span> est une offre signée **Amaru Properties**. Il s'active dès que vous réservez une villa éligible via notre plateforme digitale.
                </p>
                <p>
              ...
              <div className="mt-16">
                <Link 
                    href="/" 
                    className="group inline-flex items-center gap-4 bg-slate-900 dark:bg-white text-white dark:text-black px-12 py-6 rounded-2xl font-bold uppercase text-[11px] tracking-[0.3em] hover:bg-[#D4AF37] dark:hover:bg-[#D4AF37] transition-all duration-500 shadow-2xl shadow-slate-900/20"
                >
