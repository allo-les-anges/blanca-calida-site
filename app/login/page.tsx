...
export default function LoginPage() {
  ...
  // Configuration identique au Super-Admin pour une synchronisation parfaite
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.session) {
        console.log("Session validée, redirection en cours...");
        
        // On attend 1 seconde pour laisser au navigateur le temps de 
        // graver les cookies de session sur le disque.
        setTimeout(() => {
